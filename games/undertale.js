let undertale = {
    ...
    locations: {
        ...
        room_fire_core1:        {x: 160,  y: 50,  w: 8,  h: 8,  name: "Core 1"},
        ...
        room_fire_core5:        {x: 170,  y: 50,  w: 8,  h: 8,  name: "Core 5"},
        ...
        room_fire_core_branch:        {x: 180,  y: 50,  w: 8,  h: 8,  name: "Core Branch Save"},
        //room_fire_core_bottomleft:        {x: 240,  y: 30,  w: 8,  h: 8,  name: "Core Bottom Left"},
        room_fire_core_left:        {x: 190,  y: 50,  w: 8,  h: 8,  name: "Core Left"},
        room_fire_core_topleft:        {x: 200,  y: 50,  w: 8,  h: 8,  name: "Core Top Left"},
        room_fire_core_top:        {x: 160,  y: 60,  w: 8,  h: 8,  name: "Core Top"},
        room_fire_core_topright:        {x: 170,  y: 60,  w: 8,  h: 8,  name: "Core Top Right"},
        room_fire_core_right:        {x: 180,  y: 60,  w: 8,  h: 8,  name: "Core Right"},
        //room_fire_core_bottomright:        {x: 250,  y: 40,  w: 8,  h: 8,  name: "Core Bottom Right"},
        room_fire_core_center:        {x: 190,  y: 60,  w: 8,  h: 8,  name: "Core Center"},
        ...
        room_fire_core_premett:        {x: 200,  y: 60,  w: 8,  h: 8,  name: "Core Pre Mettaton"},
        //room_fire_core_metttest:        {x: 230,  y: 60,  w: 8,  h: 8,  name: "Core Mettaton"},
        room_asghouse1:        {x: 210,  y: 20,  w: 8,  h: 8,  name: "Asgore's House Stairs"},
        room_asghouse3:        {x: 220,  y: 20,  w: 8,  h: 8,  name: "Asgore's House Hallway"},
    },
